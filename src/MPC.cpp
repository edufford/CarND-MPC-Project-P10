...
// Param length from front wheels to CG to approximate vehicle's turning radius.
...
// Target velocity for cost function (boosted to 115mph to have some margin
//   for cost function to achieve actual 110mph peak speed on lake track)
